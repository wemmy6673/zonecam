        ...
        <div className="mx-auto justify-center">
            <div className='flex flex-col px-16 md:px-0 space-y-2 items-center w-[100%] pt-16'>
                ...
                <div className='flex flex-col space-y-4 md:space-y-4'>
                   ...
                   <Link to='./LandingPage'> <button className='bg-green-600 hover:border hover:border-green-600 hover:bg-white hover:text-green-600 text-white rounded-3xl py-3 px-6'>Get started</button> </Link>
                </div>
            </div>
